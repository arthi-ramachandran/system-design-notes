...
Here’s a curated list of software system design concepts that help TPMs feel confident in design discussions:

📂 system-design-notes\
├── 📂 01-fundamentals (CAP Theorem, PACELC, Latency vs Throughput)\
├── 📂 02-databases\
│   ├── relational-db-deep-dive.md\
│   ├── nosql-patterns.md\
│   └── caching-strategies.md\
├── 📂 03-communication\
│   ├── rest-vs-grpc-vs-graphql.md\
│   └── message-queues-pubsub.md\
├── 📂 04-infrastructure-components\
│   ├── load-balancers.md\
│   ├── api-gateways.md\
│   └── cdn-and-edge-computing.md\
├── 📂 05-case-studies (How to design YouTube, WhatsApp, etc.)\
└── 📂 06-diagrams \
